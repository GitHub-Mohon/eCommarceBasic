        <footer class="footer footer-dark">
	            		...
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget">
	            				...
	            				<ul class="widget-list">
	            					<li><a href="{{url('about')}}">About eCommerce</a></li>
	            					<li><a href="{{'shop'}}">How to shop on eCommerce</a></li>
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		<p class="footer-copyright">Copyright © {{ \Carbon\Carbon::now()->year }} eCommerce Website. All Rights Reserved.</p><!-- End .footer-copyright -->
