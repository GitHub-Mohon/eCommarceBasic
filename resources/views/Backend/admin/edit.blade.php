...
<div class="content-wrapper">
  ...
  <input type="text" name="name" class="form-control" id="exampleInputAcademic1" value="{{old('name',$admin->name)}}">
  @error('name')
  ...
  <input type="email" name="email" class="form-control" id="exampleInputAcademic1" value="{{ old('email',$admin->email)}}">
  @error('email')
  <p class="text-danger">{{$message}}</p>
  @enderror
  </div>
