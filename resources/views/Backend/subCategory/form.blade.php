...
<div class="content-wrapper">
  ...
  <li class="breadcrumb-item"><a href="{{route('sub-category.read')}}">All Sub Category</a></li>
  </ol>
  </div>
  </div>
  </div>
  ...
  <label for="exampleInputAcademic1">Category Name<span style="color: red">*</span></label>
  ...
  <div class="form-group">
  <label for="exampleInputAcademic1">Sub Category Name<span style="color: red">*</span></label>
  ...
  <div class="form-group">
  <label for="exampleInputAcademic1">Sub Category Picture<span style="color: red">*</span></label>
